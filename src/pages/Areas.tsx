    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Gestión de Áreas</h1>
                    <p className="text-gray-600 dark:text-gray-400 mt-1">Administra las áreas y departamentos de la empresa</p>
                </div>
                ...
                <CardContent className="pt-6">
                    {areas.length === 0 ? (
                        <div className="text-center py-12">
                            ...
                            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">No hay áreas registradas</h3>
                            <p className="text-gray-500 dark:text-gray-400 mb-6">Comienza creando las áreas de tu empresa o carga las sugeridas.</p>
                            ...
                            <table className="w-full">
                                <thead>
                                    <tr className="border-b border-gray-200 dark:border-gray-700">
                                        <th className="text-left py-3 px-4 font-semibold text-gray-900 dark:text-white">Nombre</th>
                                ...
                                <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                                    {areas.map((area) => (
                                        <tr key={area.id} className="hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                                            <td className="py-3 px-4 font-medium text-gray-900 dark:text-white">{area.name}</td>
                                            <td className="py-3 px-4">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    />
                                                    <span className="text-sm text-gray-500 dark:text-gray-400 uppercase">{area.color}</span>
                                                </div>
                                            </td>
                                            <td className="py-3 px-4 text-right">
                                                <div className="flex justify-end gap-2">
                                                    <button
                                                        ...
                                                        className="p-1 text-gray-400 hover:text-[#0A4D8C] dark:hover:text-blue-400 transition-colors"
                                                        title="Editar"
                                                    >
